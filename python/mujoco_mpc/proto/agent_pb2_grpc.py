...
class AgentStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetAnything = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetBackwardPassResults = channel.unary_unary(
                '/agent.Agent/GetBackwardPassResults',
                request_serializer=agent__pb2.GetBackwardPassResultsRequest.SerializeToString,
                response_deserializer=agent__pb2.GetBackwardPassResultsResponse.FromString,
                _registered_method=True)
...
class AgentServicer(object):
    ...
    def GetBackwardPassResults(self, request, context):
        """Get values from backwards pass
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AgentServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBackwardPassResults': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBackwardPassResults,
                    request_deserializer=agent__pb2.GetBackwardPassResultsRequest.FromString,
                    response_serializer=agent__pb2.GetBackwardPassResultsResponse.SerializeToString,
            ),
    }
...
class Agent(object):
    ...
    @staticmethod
    def GetBackwardPassResults(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agent.Agent/GetBackwardPassResults',
            agent__pb2.GetBackwardPassResultsRequest.SerializeToString,
            agent__pb2.GetBackwardPassResultsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
